...
#ifndef _TJDMXVIEWERPLUGIN_H
#define _TJDMXVIEWERPLUGIN_H

class DMXViewerPlugin: public OutputPlugin {
	public:
		DMXViewerPlugin(strong<DMXPlugin> plug);
		virtual ~DMXViewerPlugin();
